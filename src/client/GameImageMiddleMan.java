...
public final class GameImageMiddleMan extends GameImage {
     ...
     */
    public final void doSpriteClip1(int i, int j, int k, int l, int i1, int j1, int xOffs) {
        if (i1 >= 50000) {
            _mudclient.method71(i, j, k, l, i1 - 50000, j1, xOffs);
            return;
        }
        if (i1 >= 40000) {
            _mudclient.drawItems(i, j, k, l, i1 - 40000, j1, xOffs);
            return;
        }
        if (i1 >= 20000) {
            _mudclient.method45(i, j, k, l, i1 - 20000, j1, xOffs);
            return;
        }
        if (i1 >= 5000) {
            _mudclient.method52(i, j, k, l, i1 - 5000, j1, xOffs);
            return;
        }
